//****************************************************************************
//  Copyright (c) 2008-2014  Derell Licht
...
// lint -esym(1714, resize_terminal_pixels)
...
//********************************************************************
struct term_lview_item {
   struct term_lview_item *next {nullptr};
   TCHAR *msg {nullptr};
   uint idx {};
   bool marked {};
   COLORREF fgnd {};
...
typedef term_lview_item *term_lview_item_p ;
